...
class OperationFactory:
    ...
    def register(self, operation_name: str, operation_func, supported_types: list[str]):
        ...
        """
        self._registry[operation_name] = {"func": operation_func, "supported_types": supported_types}
...
def register_operation(operation_name: str, operation_func, supported_types: list[str]):
    """
